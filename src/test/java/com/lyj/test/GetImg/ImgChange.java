...
public class ImgChange {
	...
	// 存放所有下载验证码的目录
	private static final String DOWNLOAD_DIR = "C:\\Users\\Administrator\\Pictures\\文字识别\\tmp\\download";

	// 存放已经拆分开的单个数字图片的目录，供比对用
	private static final String TRAIN_DIR = "C:\\Users\\Administrator\\Pictures\\文字识别\\tmp\\train";

	// 存放比对结果的目录（重新以验证码所含数字命名文件，非常直观）
	private static final String RESULT_DIR = "C:\\Users\\Administrator\\Pictures\\文字识别\\tmp\\result";
	 ...
	 * 去除图像干扰像素
	 */
	public static BufferedImage removeInterence(BufferedImage image) throws Exception {
	...
	/*
	 * 判断拆分验证码的标注：就是定义验证码中包含的个数字的x，y坐标值，及它们的宽度（width）、高度（height）。
	 */
	...
	/*
	 * 判断字体的颜色含义：正常可以用rgb三种颜色加起来表示，字与非字应该有显示的区别，找出来。
	 */
	...
	/*
	 * 将下载的验证码图片全部拆封到另外一个目录
	 */
	public void generateStdDigitImage() throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		// 第8步，提供给外界接口调用。
		// String validateCode = ImageProcess.getValidateCode(new
		// File(DOWNLOAD_DIR, "0.png"));
